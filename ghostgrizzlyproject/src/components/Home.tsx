...
export default function Home(): JSX.Element {
    return (
        <>
            {/* Hero Section */}
            <section className="flex flex-col items-center justify-center text-center px-4 py-28 sm:py-40 max-w-5xl mx-auto bg-black/60 backdrop-blur-sm rounded-xl mt-10 shadow-xl">
